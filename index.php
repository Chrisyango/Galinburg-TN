	...
	<section id="content" style="background:url('./_assets_/images/content-bg.jpg') center no-repeat;background-size:cover;">
		<section id="welcome">
			<div class="container">
				<div class="row">
					<div class="col-md-6">
						<h2><span>an adventrue like no other</span> welcome</h2>
						<a href="./">read more</a>
		...
		<section id="alerts">
			...
			<div class="img-container">
				...
				<div class="alerts-img" style="background:url('./_assets_/images/alerts3.jpg') center no-repeat;background-size:cover;"></div>
				<div class="alerts-img" style="background:url('./_assets_/images/alerts4.jpg') center no-repeat;background-size:cover;"></div>
				<div class="alerts-img" style="background:url('./_assets_/images/alerts5.jpg') center no-repeat;background-size:cover;"></div>
				<div class="alerts-img" style="background:url('./_assets_/images/alerts6.jpg') center no-repeat;background-size:cover;"></div>
			</div><!-- /.img-container -->
